...
public abstract class Player extends Entity {
	...
	/**
	 * A játékost megmentik, amennyiben vízben van. Ha nem volt vízben, akkor
	 * visszatér hamis értékkel. Ha vízben volt, akkor átkerül a
	 * paraméterként kapott fieldre.
	 */
	public boolean GetSaved(IceField f) {
		...
		f.Accept(this);
		game.PlayerSaved();
		field.Remove(this); // úgy írtam a field Remove-ját, hogy itt ne kelljen még külön a vízben
							// lévők közül is kiszedni
		field = f;
		return true;
	}
	...
	/**
	 * A játékos átlép egy másik mezőre. Ha kimenne a pályáról, a program
	 * jelzi, hogy ezt nem teheti.
	 */
	...
	/**
	 * Egy item bekerül a játékos eszköztárába. Ha már van nála, akkor ezt
	 * egy false értékkel jelzi.
	 */
	...
	/**
	 * A játékos beleesik a vízbe. Ezt a játéknak is jelzi a játékos.
	 */
